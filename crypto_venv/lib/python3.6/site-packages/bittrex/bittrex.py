...
class Bittrex(object):
    ...
    def get_historical_data(self, marketName, interval):
        """
		Queries Bittrex with given method and options

		:param marketName: specific market
		:type marketName: str

		:param interval: interval for bittrex
		:type interval: str
        ...
        base_url = 'https://bittrex.com/api/v2.0/pub/market/getTicks'

        request_url = base_url + '?marketName=' + marketName + "&tickInterval=" + interval
