...
PUBLIC_SET = ['getmarkets', 'getcurrencies', 'getticker', 'getmarketsummaries', 'getorderbook',
			  'getmarkethistory','getmarketsummary']
...
class Bittrex(object):
	...
	def __init__(self, api_key, api_secret):
		...
		self.public_set_v2 = set(PUBLIC_SET_V2)
	...
	def api_query(self, method, options=None):
		...
		base_url_v2 = 'https://bittrex.com/Api/v2.0/%s/'
		request_url = ''
		...
		elif method in self.public_set_v2:
			request_url = (base_url_v2 % 'pub/market') + method + '?'

		request_url += urllib.parse.urlencode(options)

		signature = hmac.new(b'{self.api_secret}', request_url.encode('utf-8'), hashlib.sha512).hexdigest()
	...
	def get_market_summary(self,market):
		"""
		Used to get the last 24 hour summary of a market

		:return: Summary of active market exchange in JSON
		:rtype : dict
		"""
	...
	def get_ticks(self,market,period):
		"""
                Used too data chart information about a given market
                in a given period.
                ...
                :rtype : dict
                """
		return self.api_query('GetTicks',{'marketName': market,'tickInterval': period})
